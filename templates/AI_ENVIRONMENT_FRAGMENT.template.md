# AI Environment Fragment: {{FRAGMENT_CODE}} - {{FRAGMENT_TITLE}}

> Managed document. Must comply with template AI_ENVIRONMENT_FRAGMENT.template.md.
...
<!-- APM:DATA
{
  ...
  "fragment": {
    ...
    "templateName": "AI_ENVIRONMENT_FRAGMENT.template.md",
...
[
  {
    ...
    "targetSection": "{{TARGET_SECTION:term-dictionary|required-behaviors|module-update-rules|project-family-read-order|project-family-inheritance-rules|data-phrasing-rules|avoid-rules|handoff-checklist|open-questions}}",
