# Experience Design Fragment Template

> Template Contract. Keep filename `EXPERIENCE_DESIGN_FRAGMENT.template.md`; APM discovers and syncs templates by this name.
> Managed document. Must comply with template EXPERIENCE_DESIGN_FRAGMENT.template.md.

## 1. Template Contract Metadata

- Template Name: `EXPERIENCE_DESIGN_FRAGMENT.template.md`
- Template Version: `1.4`
- Last Updated: `2026-04-23`
- Template Kind: `fragment`
- Owning Module: `Experience Design`
- Generated Artifact: `EXPERIENCE_DESIGN_FRAGMENT_*.md`
...
Use this fragment to propose Experience Design changes without editing `EXPERIENCE_DESIGN.md` directly.

## Required Sections

1. Executive Summary
2. Journey or Screen Updates
3. State and Interaction Updates
