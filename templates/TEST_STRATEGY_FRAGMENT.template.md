# Test Strategy Fragment Template

> Template Contract. Keep filename `TEST_STRATEGY_FRAGMENT.template.md`; APM discovers and syncs templates by this name.
> Managed document. Must comply with template TEST_STRATEGY_FRAGMENT.template.md.

## 1. Template Contract Metadata

- Template Name: `TEST_STRATEGY_FRAGMENT.template.md`
- Template Version: `1.4`
- Last Updated: `2026-04-23`
- Template Kind: `fragment`
- Owning Module: `Test Strategy`
- Generated Artifact: `TEST_STRATEGY_FRAGMENT_*.md`
...
Use this fragment to propose test-strategy updates without editing `TEST_STRATEGY.md` directly.

## Required Sections

1. Executive Summary
2. Validation Scope Updates
3. Test Layer Updates
4. Risk and Coverage Notes
5. Open Questions
6. Merge Guidance
