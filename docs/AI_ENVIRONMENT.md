...
<!-- APM:DATA
{
  ...
  "editorState": {
    ...
    "overview": {
      ...
      "versionDate": "2026-04-19T18:49:48.175Z",
      "itemIds": {
    ...
    "avoidRules": [
      ...
      },
      {
        ...
        "description": "Keep PRD Future Enhancements lightweight and product-facing only. Active planned feature tracking belongs in FEATURES.md; implemented and archived feature history belongs in database-backed history or archive views.",
